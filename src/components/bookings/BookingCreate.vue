          ...
          <div class="pt-4 pl-2 md:w-2/3">
            ...
            <div class="flex flex-col">
              <div class="flex items-center mr-4 mt-2">
                <img src="/gear.png" alt="gear" class="w-5 h-5 mr-2" />
                <p class="text-gray-600">{{ car.gear }}</p>
              </div>
              <div class="flex items-center mr-4 mt-2">
                <img src="/user.png" alt="user" class="w-5 h-5 mr-2" />
              ...
              <div class="flex items-center mr-4 mt-2">
                <img src="/door.png" alt="door" class="w-5 h-5 mr-2" />
                <p class="text-gray-600">
                  {{ car.doors }}
              ...
              <div class="flex items-center mt-2 mb-4">
                <img src="/dollar.svg" alt="dollar" class="w-5 h-5 mr-2" />
        ...
        <div class="bg-white p-4 rounded shadow-md w-72 absolute">
          <div ref="receiptContainer" class="bg-white w-full">
            <div class="flex justify-center w-full mb-8 items-center">
              <img src="/racing.png" alt="Company Logo" class="h-8 w-8 mr-2" />
          ...
          >
            <img src="/downloads.png" alt="logout icon" class="h-4 w-4 mr-2" />
            Download Receipt
          </button>
        </div>
      </div>
